            ...
            if (isOverWater)
            {
                for (int i = 0; i < buoyancyPoints.Count; i++)
                {
                    ...
                    {                        
                        ...
                        rb.AddForce(displacementModifier * -rb.linearVelocity * waterDrag * Time.fixedDeltaTime, ForceMode.VelocityChange);
    ...
    public class Buoyancy_Editor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (generalFoldout)
            {
                ...
                if (copyToTransform.boolValue == true)
